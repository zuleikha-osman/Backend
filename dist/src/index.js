...
app.use("/sales", saleRoutes_1.default); // http://localhost:8000/sales
app.use("/purchases", purchaseRoutes_1.default); // http://localhost:8000/purchases
app.use("/customers", customerRoutes_1.default); // http://localhost:8000/customers
app.use("/summary", summaryRoutes_1.default); // http://localhost:8000/summary
/* SERVER */
